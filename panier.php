                ...
                <div class="row">
                    ...
                    <div class="col-md-2 flex_center_davy">
                        <p>
                            ...
                            <!-- Diminuer -->
                            <a href="<?= URL ?>/panier?action=diminuer&id_produit=<?= $_SESSION['panier']['id_produit'][$i] ?>" title="Diminuer" class="p-3">-</a>
                            <!-- Quantité -->
                            <?= $_SESSION['panier']['quantite'][$i] ?>
                            <!-- Augmenter -->
                            <a href="<?= URL ?>/panier?action=augmenter&id_produit=<?= $_SESSION['panier']['id_produit'][$i] ?>" title="Augmenter" class="p-3">+</a>
                        </p>
                    </div>
                    <div class="col-md-2 flex_center_davy">
