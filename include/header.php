        ...
        <header>
            ...
            <div class="nav_mobile_burger_davy">
                <div class="m-5">
                    ...
                    <hr class="hr_admin_davy">
                    <a href="<?= URL ?>/<?php if (!isset($_SESSION['membre'])) {echo 'connexion';} if (isset($_SESSION['membre']) && $_SESSION['membre']['statut'] == 1) {echo 'profil';} if (isset($_SESSION['membre']) && $_SESSION['membre']['statut'] == 2) {echo 'admin/dashboard';} if (isset($_SESSION['membre']) && $_SESSION['membre']['statut'] == 3) {echo 'partenaire';} ?>" title="Profil" class="d-inline-block width_full_davy lien_profil">Profil</a>
                    <hr class="hr_admin_davy">
