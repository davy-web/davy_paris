        ...
        <header>
            ...
            <div class="nav_mobile_davy">
                <div class="nav_mobile_center_davy">
                    <a href="<?= URL ?>/liste-experiences" class="menu_mobile_davy lien_liste_experiences" title="Activités">
                        ...
                        <br>
                        <p class="texte_menu_mobile_davy lien_liste_experiences">Activités</p>
                    </a>
                    <a href="<?= URL ?>/liste-box" class="menu_mobile_davy lien_liste_box" title="Box">
                        ...
                        <br>
                        <p class="texte_menu_mobile_davy lien_liste_box">Box</p>
                    </a>
                    <a href="<?= URL ?>/favoris" class="menu_mobile_davy lien_favoris" title="Favoris">
                        ...
                        <br>
                        <p class="texte_menu_mobile_davy lien_favoris">Favoris</p>
                    </a>
                    <a href="<?= URL ?>/panier" class="menu_mobile_davy lien_panier" title="Panier">
                        ...
                        <br>
                        <p class="texte_menu_mobile_davy lien_panier">Panier</p>
                    </a>
            ...
            <div class="nav_mobile_burger_davy">
                <div class="m-5">
                    ...
                    <hr class="hr_admin_davy">
                    <a href="<?= URL ?>/<?php if (isset($_SESSION['membre']) && $_SESSION['membre']['statut'] == 1) {echo 'profil';} if (isset($_SESSION['membre']) && $_SESSION['membre']['statut'] == 2) {echo 'admin/dashboard';} if (isset($_SESSION['membre']) && $_SESSION['membre']['statut'] == 3) {echo 'partenaire';} ?>" title="Profil" class="d-inline-block width_full_davy lien_profil">Profil</a>
                    <hr class="hr_admin_davy">
