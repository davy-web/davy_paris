...
?>
        ...
        <div id="content_davy">
            ...
            <div class="container text_center_davy mt-5 mb-3">
                ...
                <h1 class="h2_moyen_davy">Conditions générales de vente de prestations de services en ligne à des consommateurs particuliers</h1>
                <hr class="anime_scroll_davy block_center_davy">
            </div>
            <div class="container mb-3">
                <div class="row">
                    <p class="mb-5">
                        Les présentes conditions générales de vente s'appliquent à toutes les prestations de services conclues sur le site Internet Dating Paris.<br>
                        Le site Internet Dating Paris est un service de :<br>
                        - la société Dating Paris<br>
                        - située à : 80 Rue Jules Ferry, 93170 Bagnolet<br>
                        - adresse URL du site : https://dating-paris.one-website.com<br>
                        - adresse mail : chendavyweb@gmail.com<br>
                        - téléphone : 07 81 65 80 77<br>
                    ...
                    <h3 class="color_red_davy">Article 1 - Contenu et champ d'application</h3>
                    <p class="mb-5">
                        Les présentes conditions générales de vente s'appliquent de plein droit aux prestations de services suivantes : Coffret de voyage.<br>
                    ...
                    <h3 class="color_red_davy">Article 2 - Informations précontractuelles</h3>
                    <p class="mb-5">
                    ...
                    <h3 class="color_red_davy">Article 3 - Commande</h3>
                    <p class="mb-5">
                    ...
                    <h3 class="color_red_davy">Article 4 - Devis</h3>
                    <p class="mb-5">
                        ...
                        Les devis établis par le prestataire ont une durée de validité de 15 jours.<br>
                    </p>
                    <h3 class="color_red_davy">Article 5 - Exécution de la prestation et résolution du contrat</h3>
                    <p class="mb-5">
                        Sauf conditions particulières expresses propres à la vente, l'exécution de la prestation s'effectuera dans le délai de 2 jours ouvrables à compter de la réception par le vendeur d'une commande en bonne et due forme.<br>
                    ...
                    <h3 class="color_red_davy">Article 5 bis - Renouvellement du contrat</h3>
                    <p class="mb-5">
                        La prestation objet de ce contrat fait l'objet d'un contrat dont la durée est de 1 an, renouvelable pour une même durée par tacite reconduction.<br>
                    ...
                    <h3 class="color_red_davy">Article 6 - Délai de rétractation et remboursement</h3>
                    <p class="mb-5">
                        L'acheteur dispose d'un droit de rétractation de 14 jours à compter de la conclusion du contrat.<br>
                        Le professionnel doit rembourser l'acheteur de la totalité des sommes versées, au plus tard dans les 14 jours à compter de la date à laquelle il est informé de la décision de l'acheteur de se rétracter (C. consom., art. L. 221-24), sauf retard justifié.<br>
                        Conformément à l'article L. 242-4 du code de la consommation, lorsque le professionnel n'a pas remboursé les sommes versées par l'acheteur, les sommes dues sont de plein droit majorées :<br>
                        - du taux d'intérêt légal si le remboursement intervient au plus tard 10 jours après l'expiration du délai de 14 jours énoncé ci-dessus,<br>
                        - de 5 % si le retard est compris entre 10 et 20 jours,<br>
                        - de 10 % si le retard est compris entre 20 et 30 jours,<br>
                        - de 20 % si le retard est compris entre 30 et 60 jours,<br>
                        - de 50 % entre 60 et 90 jours,<br>
                        - et de cinq points supplémentaires par nouveau mois de retard jusqu'à concurrence du prix du produit, puis du taux d'intérêt légal.<br><br>
                        Annulation de la commande après le délai de rétractation<br>
                        Après le délai de rétractation de 14 jours, en cas d'annulation de la commande par l'acheteur, après acceptation du vendeur, pour quelque raison que ce soit hormis la force majeure, une somme correspondant à 10 % du montant de l'achat sera acquise au vendeur, à titre de dommages et intérêts, en réparation du préjudice ainsi subi.<br>
                    </p>
                    <h3 class="color_red_davy">Article 7 - Prix</h3>
                    <p class="mb-5">
                    ...
                    <h3 class="color_red_davy">Article 8 - Paiement</h3>
                    <p class="mb-5">
                        Sauf autres modalités prévues expressément par les conditions particulières, le paiement du prix s'effectue comptant à la commande. Aucune commande ne pourra être prise en compte à défaut d'un complet paiement à cette date.<br>
                    ...
                    <h3 class="color_red_davy">Article 9 - Garanties - Généralités</h3>
                    <p class="mb-5">
                        9-1 Garantie légale de conformité<br>
                        Dating Paris est garant de la conformité du bien vendu au contrat, permettant à l'acheteur de formuler une demande au titre de la garantie légale de conformité prévue aux articles L. 217-4 et suivants du code de la consommation.<br>
                    ...
                    <h3 class="color_red_davy">Article 10 - Propriété intellectuelle</h3>
                    <p class="mb-5">
                        Tous les documents techniques, produits, dessins, photographies remis aux acheteurs demeurent la propriété exclusive de Dating Paris, seul titulaire des droits de propriété intellectuelle sur ces documents, et doivent lui être rendus à sa demande.<br>
                    ...
                    <h3 class="color_red_davy">Article 11 - Juridiction compétente</h3>
                    <p class="mb-5">
                        Tous les litiges auxquels les opérations d'achat et de vente conclues en application des présentes conditions générales de vente pourraient donner lieu, concernant tant leur validité, leur interprétation, leur exécution, leur résiliation, leurs conséquences et leurs suites et qui n'auraient pas pu être résolus à l'amiable entre le vendeur et le client, seront soumis aux tribunaux compétents dans les conditions de droit commun.<br>
                        Pour la définition de la juridiction compétente, le vendeur élit domicile à 80 Rue Jules Ferry, 93170 Bagnolet.<br>
                    </p>
                    <h3 class="color_red_davy">Article 12 - Langue du contrat</h3>
                    <p class="mb-5">
                    ...
                    <h3 class="color_red_davy">Article 13 - Médiation et règlement des litiges</h3>
                    <p class="mb-5">
                        ...
                        En cas de contestation, les coordonnées du médiateur auquel l'acheteur peut s'adresser sont les suivantes : médiateur du e-commerce de Dating Paris, Davy CHEN, 80 Rue Jules Ferry, 93170 Bagnolet, chendavyweb@gmail.com.<br>
                        <br>
                        Conformément à l’article 14 du Règlement (UE) n°524/2013, la Commission Européenne a mis en place une plateforme de Règlement en Ligne des Litiges, facilitant le règlement indépendant par voie extrajudiciaire des litiges en ligne entre consommateurs et professionnels de l’Union européenne. Cette plateforme est accessible au lien suivant : https://webgate.ec.europa.eu/odr/.<br>
                    </p>
                    <h3 class="color_red_davy">Article 14 - Loi applicable</h3>
                    <p class="mb-5">
                        Les présentes conditions générales sont soumises à l'application du droit français. <br>
                        Il en est ainsi pour les règles de fond comme pour les règles de forme. En cas de litige ou de réclamation, l'acheteur s'adressera en priorité au vendeur pour obtenir une solution amiable.<br>
                    </p>
                    <h3 class="color_red_davy">Article 15 - Protection des données personnelles</h3>
                    <p class="mb-5">
                        Données collectées :<br>
                        Les données à caractère personnel qui sont collectées sur ce site sont les suivantes :<br>
                        - ouverture de compte : lors de la création du compte de l'utilisateur, ses nom ; prénom ; adresse électronique ; <br>
                        ...
                        - cookies : les cookies sont utilisés, dans le cadre de l'utilisation du site. L'utilisateur a la possibilité de désactiver les cookies à partir des paramètres de son navigateur.<br>
                        <br>
                        Utilisation des données personnelles<br>
                        Les données personnelles collectées auprès des utilisateurs ont pour objectif la mise à disposition des services du site web, leur amélioration et le maintien d'un environnement sécurisé. Plus précisément, les utilisations sont les suivantes :<br>
                        ...
                        Partage des données personnelles avec des tiers<br>
                        Les données personnelles peuvent être partagées avec des sociétés tierces, dans les cas suivants :<br>
                        -  quand l'utilisateur utilise les services de paiement, pour la mise en oeuvre de ces services, le site web est en relation avec des sociétés bancaires et financières tierces avec lesquelles elle a passé des contrats ;<br>
                        ...
                        En application de la réglementation applicable aux données à caractère personnel, les utilisateurs disposent des droits ci-dessous mentionnés, qu'ils peuvent exercer en faisant leur demande à l'adresse suivante : chendavyweb@gmail.com<br>
                        ...
                        Evolution de la présente clause<br>
                        Le site web se réserve le droit d'apporter toute modification à la présente clause relative à la protection des données à caractère personnel à tout moment. Si une modification est apportée à la présente clause de protection des données à caractère personnel, le site web s'engage à publier la nouvelle version sur son site. Le site web informera également les utilisateurs de la modification par messagerie électronique, dans un délai minimum de 15 jours avant la date d'effet. Si l'utilisateur n'est pas d'accord avec les termes de la nouvelle rédaction de la clause de protection des données à caractère personnel, il a la possibilité de supprimer son compte.<br>
                    </p>
                </div>
            </div>
        </div>
